...
public class Art {
	...
	public static Bitmap items = loadNinjaBitmap("/tex/items.png");
	public static Bitmap sky = loadBitmap("/tex/sky.png");

	public static Bitmap logo = loadNinjaBitmap("/gui/logo.png");

	public static Bitmap loadNinjaBitmap(String fileName) {
		try {
